  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <form action="{{ route('notice.store',$notice->id) }}" method="POST" enctype="multipart/form-data" class="mb-0" id="noticeform">
          @csrf    
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <textarea name="notice_description" class="ckeditor form-control">{{old('notice_description')}}</textarea>
                </div>   
                <div class="form-group">
