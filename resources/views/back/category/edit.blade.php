  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <form action="{{route('category.update',$category->id)}}" method="POST" enctype="multipart/form-data" class="mb-0" id="catform">
          @csrf    
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="@if ($errors->has('title')) inputError @endif" class="form-control @if ($errors->has('title')) is-invalid @endif" placeholder="Enter Title" value="{{$category->title}}">
                  @error('title')
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" name="is_parent" value='{{$category->is_parent}}' {{(($category->is_parent==1)? 'checked' : '')}}> Yes
                </div>
                {{-- {{$parent_cats}} --}}
                {{-- {{$category}} --}}
                <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
                <label for="parent_id">Parent Category<span class="required">*</span></label><br/>
                ...
                <div class="form-group">
                  ...
                  <img src="{{asset('/Images/categories/'.$category->photo) }}"style="height:50px; width:50px;" class="form-control">
